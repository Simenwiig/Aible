	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord183 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 tex2DNode162 = tex2D( _BaseAlbedoASmoothness, uv_BaseAlbedoASmoothness162 );
				float4 temp_output_163_0 = ( _BaseColor * tex2DNode162 );
				float2 texCoord183 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_182_0 = ( texCoord183 * _DetailUVScale );
				float4 blendOpSrc178 = ( tex2D( _DetailAlbedo, temp_output_182_0 ) * 2.0 );
				float4 blendOpDest178 = temp_output_163_0;
				float4 lerpResult187 = lerp( temp_output_163_0 , ( saturate( (( blendOpDest178 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest178 ) * ( 1.0 - blendOpSrc178 ) ) : ( 2.0 * blendOpDest178 * blendOpSrc178 ) ) )) , _DetailAlbedoIntensity);
...
/*ASEBEGIN
Version=18935
1920;78;1920;1019;6761.789;4279.531;5.499376;True;False
...
Node;AmplifyShaderEditor.FunctionNode;340;-4352,544;Inherit;False;AG Global Snow - Height;-1;;5;792d553d9b3743f498843a42559debdb;0;0;1;FLOAT;43
...
Node;AmplifyShaderEditor.StaticSwitch;270;-3967,-1664;Float;False;Property;_TopEnableNoise;Top Enable Noise;7;0;Create;True;0;0;0;False;1;Header(Top);False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=5D903A6EA026D97E06AEA97FD59448DAA7C05AD4