...
Shader "ANGRYMESH/Nature Pack/URP/Props Snow"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_BaseAlbedoASmoothness162 = IN.ase_texcoord8.xy;
				...
				float2 uv_BaseNormalMap96 = IN.ase_texcoord8.xy;
				...
				float2 uv_BaseNormalMap288 = IN.ase_texcoord8.xy;
				...
				float2 uv_BaseAOANoiseMask200 = IN.ase_texcoord8.xy;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_BaseAlbedoASmoothness162 = IN.ase_texcoord4.xy;
				float4 tex2DNode162 = tex2D( _BaseAlbedoASmoothness, uv_BaseAlbedoASmoothness162 );
				float2 texCoord194 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_195_0 = ( texCoord194 * _TopUVScale );
				float4 tex2DNode172 = tex2D( _TopAlbedoASmoothness, temp_output_195_0 );
				float2 uv_BaseNormalMap96 = IN.ase_texcoord4.xy;
				float3 unpack96 = UnpackNormalScale( tex2D( _BaseNormalMap, uv_BaseNormalMap96 ), _BumpScale );
				unpack96.z = lerp( 1, unpack96.z, saturate(_BumpScale) );
				float3 tex2DNode96 = unpack96;
				float3 NormalMap166 = tex2DNode96;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				unpack96.z = lerp( 1, unpack96.z, saturate(_BumpScale) );
				float3 tex2DNode96 = unpack96;
				float2 uv_BaseNormalMap288 = IN.ase_texcoord4.xy;
				float3 unpack288 = UnpackNormalScale( tex2D( _BaseNormalMap, uv_BaseNormalMap288 ), ( _BumpScale * 0.5 ) );
				unpack288.z = lerp( 1, unpack288.z, saturate(( _BumpScale * 0.5 )) );
				float2 texCoord194 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_195_0 = ( texCoord194 * _TopUVScale );
...
/*ASEBEGIN
Version=18935
1920;80;1920;1017;7289.191;4615.022;4.884686;True;False
Node;AmplifyShaderEditor.TexturePropertyNode;287;-2688,-768;Float;True;Property;_BaseNormalMap;Base NormalMap;5;2;[Normal];[NoScaleOffset];Create;True;0;0;0;False;0;False;None;None;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;281;-5248,-1792;Half;False;Property;_TopNoiseUVScale;Top Noise UV Scale;8;0;Create;True;0;0;0;False;0;False;1;0;0.2;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;167;-5248,128;Inherit;False;166;NormalMap;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;107;-4990.107,480;Half;False;Property;_TopContrast;Top Contrast;13;0;Create;True;0;0;0;False;0;False;1;0;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;103;-4992,384;Half;False;Property;_TopOffset;Top Offset;12;0;Create;True;0;0;0;False;0;False;0.9126613;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;246;-4990.107,289.8926;Half;False;Property;_TopIntensity;Top Intensity;11;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;196;-2688,-1632;Half;False;Property;_TopUVScale;Top UV Scale;10;0;Create;True;0;0;0;False;0;False;10;0;1;30;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;175;-2048,-1760;Half;False;Property;_TopColor;Top Color;15;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;139;-2688,-288;Half;False;Property;_TopNormalIntensity;Top Normal Intensity;14;0;Create;True;0;0;0;False;0;False;1;0;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;218;-5248,-384;Half;False;Property;_TopSmoothness;Top Smoothness;9;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;216;-5248,-640;Half;False;Property;_BaseSmoothness;Base Smoothness;0;0;Create;True;0;0;0;False;1;Header(Base);False;0.5;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;119;-2048,-320;Inherit;True;Property;_TopNormalMap;Top NormalMap;17;2;[Normal];[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=2BA2013C094E7E3EEFBBA80FE14B44F18D0670D3